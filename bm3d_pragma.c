...
#ifndef __GECOS_TYPE_EXPL__
#define EXP_T_0 float
#define EXP_T_1 float
#define EXP_T_2 float
...
#define EXP_T float
typedef float EXP_T_0;
typedef float EXP_T_1;
typedef float EXP_T_2;
#endif
...
#pragma EXPLORE_FIX W={17..22} I={8} //pixel
static EXP_T hadamard_tmp[NHard] = { 0.0f };
 ...
 **/
void dct_2d_process(
#pragma EXPLORE_FIX W={13..22} I={4}  //pixel
...
void dct_2d_processinv(
	...
	for (int i = 0; i < column_index_size; i++)
	{
		for (int n = 0; n < NHW; n++) {
			...
			{
				dct_2d_inv(group_3D_table[n + NWien * i]);
			}
		}
	}
}
...
#pragma EXPLORE_FIX W={12..22} I={2} //0-1 coeff
...
#pragma EXPLORE_FIX  W={9..17} I={1} // I={1} //0-1 coeff
   ...
   {0.1924f, 0.2989f, 0.3846f, 0.4325f, 0.4325f, 0.3846f, 0.2989f, 0.1924f } };
	...
	size_t nx, ny, nc;
	float* mat_in = io_png_read_f32("/home/x80054656/projet/testimages/i04_float.png", &nx, &ny, &nc);//utiliser image denoised en flottant comme reference
	if (!mat_in) {
...
int main(int argc, char** argv) {
	clock_t t;
	t = clock();
	treat_one_image("/home/x80054656/projet/testimages/i04_gray_01_3.png", "/home/x80054656/projet/testimages/i04_(20,9).png");
